...
class DefaultIndexRegister(Renderer):
    ...
    def view():
        ...
        return json.dumps({
            ...
            "description":
                "Index register, return all registers with links navigating to them. This index register will be "
                "used when there is not register specified in @decorator.register() in routes.py.  People can "
                "replace this default register by simply adding customized index register in @decorator.register() "
                "decorator."
        })
